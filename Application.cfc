    ...
    <cffunction name="onError" returntype="void" output="true">
        ...
        <head>
            ...
            <style>
                ...
                .hint { background:rgba(56,139,253,.1); border:1px solid rgba(56,139,253,.3); border-radius:4px; padding:.75rem 1rem; font-size:.85rem; color:#79c0ff; margin-bottom:1rem; }
                .badge-event { background:rgba(139,148,158,.1); border:1px solid #30363d; color:#8b949e; font-family:'IBM Plex Mono',monospace; font-size:.72rem; padding:.2em .55em; border-radius:3px; }
            </style>
        </head>
        <body>
        <div class="err-card">
            ...
            <cfelse>
                <!--- Not logged in: show message only, no internals --->
                <p style="color:#8b949e;">The error has been logged.
                   <a href="/admin/login.cfm" style="color:#388bfd;">Sign in</a>
                   to see the full error details.</p>
            </cfif>

            <div class="mt-3">
                <a href="javascript:history.back()" class="btn btn-sm btn-outline-secondary me-2">&#8592; Back</a>
                <a href="/admin/dashboard.cfm" class="btn btn-sm btn-outline-secondary">Dashboard</a>
            </div>
        </div>
        </body>
        </html>
